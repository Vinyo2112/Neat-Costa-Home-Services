...
const TESTIMONIALS = [
  ...
  },
  {
    ...
    text: "Professional, punctual and meticulous. She doesn't just clean — she stages. Our rental income went up after the first month. Highly recommended.",
    stars: 5,
  },
];
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 gap-3">
                  {[
                    ...
                    <div key={item.size} className="bg-background rounded-2xl border border-border p-4 flex items-center justify-between gap-4">
